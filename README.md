...
KinaseCanvas packages the Cantley + curated kinase–substrate integration
extracted from JJBasalNets. It includes the supporting data inputs, derived
...
The original JJBasalNets repository contains additional patient-specific analyses
that are intentionally excluded here.
