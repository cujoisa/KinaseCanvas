---
title: "Analysis and INtegration of Cantley Atlas, PhosphoSitePlus, and HIPPIE Data"
editor: visual
...
cantley_feats <- bind_rows(cantley_serthr_long, cantley_tyr_long) %>%
  ...
  # harmonize symbols (using your symmap_kinase / symmap_subs)
...
fig1
ggsave(here("figures/paper_figures/fig1.png"), fig1, width=11, height=11, dpi=400)
```
