...
viewer_tags <- tags$div(
  ...
  tags$style(HTML("
    ...
    .page-shell{max-width:1800px;margin:0 auto;padding:24px 18px 42px;}
    ...
    #cy {width:100%;height:800px;border:1px solid var(--stroke);border-radius:12px;background:#f7f2e8}
      ...
      tags$div(class="panel",
          tags$div(
            ...
            tags$div(class="control-row",
              ...
              tags$span(class="badge kbadge", "Kinase colour")
            ),
            tags$div(class="control-row",
              ...
              tags$span(class="badge sbadge", "Substrate colour")
            ),
            tags$div(class="control-row",
        ...
        tags$div(id="exportbar",
          ...
          tags$button(id="btnFullNetwork", class="btn", "Download Full Network")
        ),
  ...
  (function(){
    ...
    function applyFilters(doLayout = true){
      ...
      cy.batch(() => {
        ...
        cy.nodes().forEach(n => {
          ...
          const noEdgeFilters = !curatedOnly && !onlyFunctional;
    ...
    document.getElementById('btnFullNetwork').addEventListener('click', () => {
      // Export all edges in the network as CSV (not just visible)
      ...
      const blob = csvBlob(rows, ['From','To','Evidence','Functional Site?','#Sites','Sites','Sources','Reference_PMID']);
      download('kinome_full_network.csv', blob);
    });
