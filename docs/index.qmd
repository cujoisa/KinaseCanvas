      ...
      tags$div(class="panel",
        tags$div(
          ...
          tags$div(class="control-row",
            ...
            tags$input(id="kinSel", list="kinList", placeholder="Type a kinase…", style="min-width:220px"),
            ...
            tags$input(id="subSel", list="subList", placeholder="Type a substrate…", style="min-width:220px"),
