    ...
    const cy = cytoscape({
      ...
      style: [
        ...
        { selector: 'node[role *= \"Substrate\"]:not([role *= \"Kinase\"])',
          style: { 'background-color': '#e9e2d6', 'border-color': '#5a5043' } },
        { selector: 'node[role *= \"Kinase\"]',
          style: { 'background-color': '#f6f1e7', 'border-color': '#3f382f' } },
        ...
        { selector: 'edge[evidence = \"Known (curated)\"]',
          style: { 'line-color': '#1f1b16', 'target-arrow-color': '#1f1b16' } },
        { selector: 'edge[evidence = \"Novel (Cantley)\"]',
          style: { 'line-color': '#5f564c', 'target-arrow-color': '#5f564c' } },
