...
# First row: Source counts (Panel B)
row1 <- p1B
...
row3 <- p1D + p1E + plot_layout(widths = c(1, 1.5))

# Combine with relative heights
fig1 <- (row1 / row2 / row3) +
  plot_layout(heights = c(1, 1.7, 1)) &
  theme(plot.tag = element_text(face = "bold"))
fig1
ggsave(here("figures/paper_figures/fig1.png"), fig1, width=544.3656/72*1.3, height=567.9596/72*1.3, dpi=500)
```
